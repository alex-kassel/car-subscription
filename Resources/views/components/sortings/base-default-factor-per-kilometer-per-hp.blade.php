<x-cars::sortings.master  :vehicle="$vehicle" headLine="{{ decimal(10_000_000 * $vehicle->sortingValue, 3) }}">

    <x-slot name="infoText">
        <p>Abo-Faktor pro 1.000 km pro 100 PS<br>inkl. aller Kosten außer Tanken</p>
        <p>bei {{ decimal($vehicle->plan->kilometers, 0) }} km monatlich</p>

        <p>
            Grundlage:<br>
            Leistung: {{ decimal($vehicle->power_hp, 0) }} PS<br>
            Kosten pro 1.000 km: {{ decimal(1000 * $vehicle->calc->baseDefaultCostPerKilometer, 2) }} €<br>
